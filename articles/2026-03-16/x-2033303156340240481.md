...
In my previous article on [The Coding Agent Harness](https://x.com/juliandeangeIis/status/2027888587975569534), I introduced Spec Driven Development as "the ultimate harness" and promised to go deeper. This is that post.
...
Not all SDD implementations are equal. On [this article](https://martinfowler.com/articles/exploring-gen-ai/sdd-3-tools.html), Birgitta Böckeler frames spec maturity with three levels:
