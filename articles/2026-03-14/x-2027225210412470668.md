...
![Pattern 1 - Isolate the tool.](https://pbs.twimg.com/media/HCIiADdbUAA0B0k?format=jpg&name=large)
...
![Pattern 2 - Isolate the agent.](https://pbs.twimg.com/media/HCIiOKub0AEMvh2?format=jpg&name=large)
...
![Scaling services independently (Backend, Agent and Control Plane)](https://pbs.twimg.com/media/HCIijR6aQAAs1F6?format=jpg&name=large)
